...
export default function AboutSection({ setActiveTab }: AboutSectionProps) {
  ...
  const pillars = [
    {
      icon: <Shield className="h-6 w-6 text-[#C5A021]" />,
    ...
    {
      icon: <Sparkles className="h-6 w-6 text-[#C5A021]" />,
    ...
    {
      icon: <HeartHandshake className="h-6 w-6 text-[#C5A021]" />,
  ...
  return (
    <div id="epic-ride-about-view" className="relative text-white bg-[#050B18] px-4 py-16 sm:px-6 lg:px-8">
      <div className="absolute top-[20%] left-0 h-96 w-96 rounded-full bg-[#C5A021]/3 blur-3xl pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto mb-16">
          ...
          <h1 className="font-sans text-4xl font-extrabold tracking-tight uppercase sm:text-6xl text-white">
            Driven by Professional <span className="text-transparent text-outline-white">Integrity</span>
          </h1>
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center mb-24">
          <div className="space-y-6">
            <h2 className="text-lg font-bold tracking-widest text-[#C5A021] font-mono uppercase">
              The Epic Ride Story
            </h2>
            ...
            <div className="pt-2">
              <button
                ...
                className="rounded-sm bg-[#C5A021] px-6 py-3.5 text-xs font-bold text-[#050B18] uppercase tracking-widest transition-colors hover:bg-amber-400"
              >
                Schedule A Ride
              </button>
            </div>
          ...
          <div className="rounded-sm border border-white/10 bg-[#0A192F]/40 p-8 space-y-6 shadow-xl backdrop-blur-sm">
            <div className="flex items-center space-x-2 text-[10px] font-mono text-[#C5A021] uppercase font-bold">
            ...
            <ul className="space-y-4 text-xs text-gray-400 font-sans">
              <li className="flex items-start space-x-3">
                <CheckCircle className="h-5 w-5 text-[#C5A021] flex-shrink-0" />
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          {pillars.map((p, idx) => (
            ...
            >
              <div className="mb-4 inline-flex rounded-sm bg-[#C5A021]/10 p-3 border border-[#C5A021]/20">
                {p.icon}
              </div>
        ...
        <div className="mt-20 rounded-sm border border-white/10 bg-[#0A192F]/40 p-6 sm:p-10 text-center max-w-4xl mx-auto backdrop-blur-sm flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-left space-y-2">
            <h4 className="text-sm font-bold text-[#C5A021] font-mono uppercase">
          ...
          <a
            ...
            className="rounded-sm border border-[#C5A021]/30 bg-[#C5A021]/10 hover:bg-[#C5A021] hover:text-[#050B18] text-[#C5A021] text-xs font-bold uppercase tracking-wider py-3 px-6 transition-all shrink-0"
          >
            Inquire Accounts
          </a>
        </div>
